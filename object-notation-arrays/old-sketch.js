...
function winDetection() {
  ...
  for (let i = 0; i < MATRIX_HEIGHT; i++) {
    ...
    // Underflowing Diagonals (What do i call these?)
    if (i - (WIN_LENGTH - 1) < 0) {
      doMinusPlusDiagonals = false;
    }
    else {
      doMinusPlusDiagonals = true;
    }
